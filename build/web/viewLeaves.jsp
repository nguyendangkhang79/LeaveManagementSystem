                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- Cột ghi chú mới thêm -->
                            <td>
                                <% if (req.getApprovalNote() != null && !req.getApprovalNote().isEmpty()) { %>
                                    <a href="#" class="note-tooltip" data-toggle="tooltip" data-html="true" 
                                       title="<%= req.getApprovalNote().replace("\"", "&quot;").replace("\n", "<br>") %>">
...
<!-- Script kích hoạt tooltip -->
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Kích hoạt tooltip cho ghi chú
        var tooltipTriggerList = document.querySelectorAll('.note-tooltip');
        for (var i = 0; i < tooltipTriggerList.length; i++) {
            var tooltipEl = tooltipTriggerList[i];
